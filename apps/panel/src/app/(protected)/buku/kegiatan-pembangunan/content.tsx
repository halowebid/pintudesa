...
import type { SelectKegiatanPembangunan } from "@pintudesa/db/schema"
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/buku/kegiatan-pembangunan/tambah">Tambah</Link>
        </Button>
      </div>
        ...
        <ControlledTable<SelectKegiatanPembangunan>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/buku/kegiatan-pembangunan/edit/${item.id}`}
