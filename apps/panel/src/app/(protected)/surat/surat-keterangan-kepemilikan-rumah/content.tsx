...
import type { SelectSuratKeteranganKepemilikanRumah } from "@pintudesa/db/schema"
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/surat/surat-keterangan-kepemilikan-rumah/tambah">
            Tambah
          </Link>
        </Button>
      </div>
        ...
        <ControlledTable<SelectSuratKeteranganKepemilikanRumah>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/surat/surat-keterangan-kepemilikan-rumah/edit/${item.id}`}
