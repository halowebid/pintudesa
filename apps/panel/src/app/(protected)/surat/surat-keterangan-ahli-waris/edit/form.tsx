...
export default function SuratKeteranganAhliWarisForm({
  ...
  const { mutate: updateSuratKuasaAhliWaris } = useMutation(
    trpc.suratKuasaAhliWaris.update.mutationOptions({
      onSuccess: async () => {
        toast({
          description: "Berhasil memperbarui surat keterangan ahli waris",
        })
      ...
      onError: (error) => {
        handleError(error, "Gagal memperbarui surat keterangan ahli waris")
      },
    }),
  )
