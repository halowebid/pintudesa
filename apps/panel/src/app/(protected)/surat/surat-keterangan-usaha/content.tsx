...
import type { SelectSuratKeteranganUsaha } from "@pintudesa/db/schema"
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/surat/surat-keterangan-usaha/tambah">Tambah</Link>
        </Button>
      </div>
        ...
        <ControlledTable<SelectSuratKeteranganUsaha>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/surat/surat-keterangan-usaha/edit/${item.id}`}
