...
import type { SelectSuratKeteranganDomisili } from "@/lib/db/schema"
...
export default function SuratKeteranganDomisiliContent() {
  ...
  const [printItem, setPrintItem] =
    React.useState<SelectSuratKeteranganDomisili | null>(null)
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/surat/surat-keterangan-domisili/tambah">
            Tambah
          </Link>
        </Button>
      </div>
        ...
        <ControlledTable<SelectSuratKeteranganDomisili>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/dashboard/surat/surat-keterangan-domisili/edit/${item.id}`}
      ...
      {printItem && (
        <PrintPreview
          suratType="surat-keterangan-domisili"
          suratData={printItem}
          open={!!printItem}
