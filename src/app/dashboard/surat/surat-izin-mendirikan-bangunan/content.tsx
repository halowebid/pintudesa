...
import type { SelectSuratIzinMendirikanBangunan } from "@/lib/db/schema"
...
export default function SuratIzinMendirikanBangunanContent() {
  ...
  const [printItem, setPrintItem] =
    React.useState<SelectSuratIzinMendirikanBangunan | null>(null)
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/surat/surat-izin-mendirikan-bangunan/tambah">
            Tambah
          </Link>
        </Button>
      </div>
      <div className="relative min-h-[100vh] w-full overflow-auto">
        <ControlledTable<SelectSuratIzinMendirikanBangunan>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/dashboard/surat/surat-izin-mendirikan-bangunan/edit/${item.id}`}
        ...
        {printItem && (
          <PrintPreview
            suratType="surat-izin-mendirikan-bangunan"
            suratData={printItem}
            open={!!printItem}
