...
import type { SelectSuratKuasaAhliWaris } from "@/lib/db/schema"
...
export default function SuratKeteranganAhliWarisContent() {
  ...
  const [printItem, setPrintItem] =
    React.useState<SelectSuratKuasaAhliWaris | null>(null)
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/surat/surat-keterangan-ahli-waris/tambah">
            Tambah
          </Link>
        </Button>
      </div>
      <div className="relative min-h-[100vh] w-full overflow-auto">
        <ControlledTable<SelectSuratKuasaAhliWaris>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/dashboard/surat/surat-keterangan-ahli-waris/edit/${item.id}`}
        ...
        {printItem && (
          <PrintPreview
            suratType="surat-kuasa-ahli-waris"
            suratData={printItem}
            open={!!printItem}
