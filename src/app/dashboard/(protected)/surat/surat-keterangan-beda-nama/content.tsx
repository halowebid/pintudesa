...
import type { SelectSuratKeteranganBedaNama } from "@/lib/db/schema"
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/surat/surat-keterangan-beda-nama/tambah">
            Tambah
          </Link>
        </Button>
      </div>
        ...
        <ControlledTable<SelectSuratKeteranganBedaNama>
          ...
          renderAction={(item) => (
            <ShowOptions
              ...
              editUrl={`/dashboard/surat/surat-keterangan-beda-nama/edit/${item.id}`}
