...
interface SuratPindahDesaBpnColumns extends InsertSuratPindahDesaBpn {
  pemohon: SelectPenduduk
}

export const suratPindahDesaBpnColumns: ColumnDef<
  SuratPindahDesaBpnColumns,
  unknown
>[] = [
  {
    accessorKey: "pemohon",
  ...
  {
    accessorKey: "nomorShm",
    meta: { isHiddenOnMobile: true },
    header: () => <span className="hidden lg:inline">Nomor SHM</span>,
    cell: ({ getValue }) => (
      <span className="hidden text-ellipsis lg:line-clamp-2">
        {getValue<string>()}
      </span>
  ...
  {
    accessorKey: "tanggalShm",
    meta: { isHiddenOnMobile: true },
    header: () => <span className="hidden lg:inline">Tanggal SHM</span>,
    cell: ({ getValue }) => {
      const val = getValue<string | Date>()
      return (
        <span className="hidden text-ellipsis lg:line-clamp-2">
...
interface SuratKeteranganUsahaColumns extends InsertSuratKeteranganUsaha {
  pemohon: SelectPenduduk
}

export const suratKeteranganUsahaColumns: ColumnDef<
  SuratKeteranganUsahaColumns,
  unknown
>[] = [
  {
    accessorKey: "pemohon",
  ...
  {
    accessorKey: "bidangUsaha",
    meta: { isHiddenOnMobile: true },
    header: () => <span className="hidden lg:inline">Bidang Usaha</span>,
    cell: ({ getValue }) => (
      <span className="hidden text-ellipsis lg:line-clamp-2">
        {getValue<string>()}
      </span>
  ...
  {
    accessorKey: "merkUsaha",
    meta: { isHiddenOnMobile: true },
    header: () => <span className="hidden lg:inline">Merk Usaha</span>,
    cell: ({ getValue }) => (
      <span className="hidden text-ellipsis lg:line-clamp-2">
        {getValue<string>()}
      </span>
  ...
  },
  {
    ...
    meta: { isHiddenOnMobile: true },
    header: () => <span className="hidden lg:inline">Alamat Usaha</span>,
    cell: ({ getValue }) => (
      <span className="hidden text-ellipsis lg:line-clamp-2">
        {getValue<string>()}
      </span>
...
interface SuratKeteranganBedaNamaColumns extends InsertSuratKeteranganBedaNama {
  pemohon: SelectPenduduk
}

export const suratKeteranganBedaNamaColumns: ColumnDef<
  SuratKeteranganBedaNamaColumns,
  unknown
>[] = [
  {
    accessorKey: "pemohon",
  ...
  {
    accessorKey: "namaLain",
    meta: { isHiddenOnMobile: true },
    header: () => <span className="hidden lg:inline">Nama Lain</span>,
    cell: ({ getValue }) => (
      <span className="hidden text-ellipsis lg:line-clamp-2">
        {getValue<string>()}
      </span>
...
export const tableColumnRegistry = {
  ...
  suratPindahDesaBpn: suratPindahDesaBpnColumns,
  ...
  suratKeteranganUsaha: suratKeteranganUsahaColumns,
  suratKeteranganBedaNama: suratKeteranganBedaNamaColumns,
} as const
