...
import ThemeSwitcher from "@/components/web/theme/theme-switcher"
import type { Session } from "@/lib/auth"
import { Button, Sheet, SheetContent, SheetTrigger } from "@/lib/ui"
...
const Header = ({
  ...
  const isStaffOrAdmin = user?.role === "member" || user?.role === "admin"
